            ...
            <ImageBackground source={require('../../assets/images/bg.jpg')} resizeMode="cover" blurRadius={4} style={styles.imageBackground} >
                ...
                <View style={styles.overlay}>
                    ...
                    <View className='content' style={{ width: '355px' }}>
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row', marginTop: '25px', marginBottom: '25px', gap: '20px', alignItems: 'center' }}>
                    ...
                    {/* Next Btn */}
                    <TouchableOpacity style={styles.nextBtn} onPress={() => router.push('/sos_screens/sos_3_2')}>
